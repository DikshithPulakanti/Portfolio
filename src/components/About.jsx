        ...
        <motion.div className="about-content" variants={itemVariants}>
          <div className="about-text">
            <p className="about-intro">
              I'm an <strong>AI Engineer & ML Researcher</strong> focused on building intelligent systems that solve 
              real-world problems. I specialize in end-to-end machine learning pipelines, generative models, and 
